...
$acts = "login,index,admin,config,staticstring,entidade,grupo_envio,dimensao,semana,todos,admin_tipo,acompanhamento,entidade_agrupamento,entidade_classificacao,entidade_pessoa,cadastro,formulario,formulario_pergunta,api.php,api_bot.php,api_eventos.php";
$actss = explode(',', $acts);
