...
?>
	...
	<?php
		if (SANDBOX && defined('SANDBOX_LOCAL')) {
			?>
	<script src="view/js/custom/custom.php?time=<?=time()?>"></script>
	<?php
		} else {
	?>
	<script src="view/js/cache/<?=$this->js_file?>"></script>
