	...
	<?php
		...
		<div class='container margintop steps-container'>
			...
			<div class='form1'>
				...
				<form method="post" action="<?=$proj?>/cadastro/parte1/" enctype="multipart/form-data">
			...
			<div class='form2'>
				...
				<form method="post" action="<?=$proj?>/cadastro/parte2/" data-add="<?=$proj?>/cadastro/addescola/" enctype="multipart/form-data">
			...
			<div class='form4'>
				<div class='col-md-12'>
					...
					<p><a href="<?=URL?>/<?=$proj?>"><?=$this->lng['fazer_cadastro']?></a></p>
				</div>
			</div>
		</div>
	</div>
