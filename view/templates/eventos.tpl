...
<div id="page-wrapper" data-escola='<?=$this->escola?>' data-lista='<?=(URL.ADMIN_FOLDER)?>/<?=$proj?>/entidade/lista_eventos/' data-add='<?=(URL.ADMIN_FOLDER)?>/<?=$proj?>/entidade/adicionar_evento/' data-del='<?=(URL.ADMIN_FOLDER)?>/<?=$proj?>/entidade/del_evento/'>
	<div class='row'>
		<ol class="breadcrumb">
