		...
		?>
			<tr>
					...
					<td>
						...
						if ($result['avaliacao']) {
						?>
						<a href='<?=$proj?>/entidade/agrupamentos/<?=$result['id']?>/<?=$this->args?>' class='btn btn-primary btn-xs' data-toggle="tooltip" title="<?=$this->lng['avaliacao_avalia']?>"><i class="glyphicon glyphicon-pencil"></i></a>
						<?php
						}
						?>
						<?php
						...
						?>
						<a href='<?=$proj?>/entidade/eventos/<?=$result['id']?>/<?=$this->args?>' class='btn btn-primary btn-xs' data-toggle="tooltip" title="<?=$this->lng['eventos_eventos']?>"><i class="glyphicon glyphicon-calendar"></i></a>
						<?php
						}
						?>
					</td>
