	...
	<div class='row'>
		<div class="col-sm-12">
				...
				?>
				<form method='post' action='<?=$proj?>/fotoadmin/miniatura_save/' enctype="multipart/form-data">
