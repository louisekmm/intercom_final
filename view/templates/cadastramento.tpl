...
<div class='container'>
	...
	?>
		<div class='col-md-12'>
			<p><a href="<?=$proj?>/formulario/exportar/<?=$this->slug?>/"><?=$this->lng['exportar_cadastrador_finalizou']?> XLS</a></p>
			<?php
			if ($this->userTipo <= 3) {
			?>
			<p><a href="<?=$proj?>/formulario/exportar/<?=$this->slug?>/?csv=1"><?=$this->lng['exportar_cadastrador_finalizou']?> CSV</a></p>
			<?php
			}
			?>
