<?php
	...
	//AVALIACAO	
		...
		$semana = $di->getDb()->query('select s.*, d.nome as dimensao, d.texto_envio, date_format(inicio, "%d/%m/%Y") as inicio, date_format(
