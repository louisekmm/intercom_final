...
class DBAdmin extends PDO {
	...
	public function __construct($dbname, $username, $password) {
        try {
        	...
        	//echo ("ola");
        	/*if(strpos($e,"[1049]") !== false)
        	 	// echo '<script>window.location.href = "http://intercom.mgovbrasil.com.br/intercom/404.html";</script>';
        	 	//header('Location: http://intercom.mgovbrasil.com.br/intercom/404.html');
        	}
        	else{*/
            	die($e->getMessage());
        	//}
